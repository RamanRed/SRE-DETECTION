...
-- Creates core tables for the SRE Incident Copilot Platform

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- -------------------------------------------------------
-- Table: incidents
-- Tracks all production incidents through their lifecycle
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- Table: remediation_records
-- Stores AI-generated root-cause analysis and fix scripts
-- linked back to a parent incident
-- -------------------------------------------------------
